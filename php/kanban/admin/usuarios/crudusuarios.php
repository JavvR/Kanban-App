<?php
    ...
    $query = "SELECT * FROM colaboradores WHERE empresa_id = '$empresa_id' AND roles_id <> 9";
    ...
    $query_rol = "SELECT * FROM roles WHERE id_empresa = '$empresa_id'";
    $roles = $conn->query($query_rol);
    $resultado_roles = $roles->fetch_all();

    $query_dpto = "SELECT * FROM departamento WHERE empresa_id = '$empresa_id'";
    $dpto = $conn->query($query_dpto);
    $resultado_dpto = $dpto->fetch_all();

    $query_sede = "SELECT * FROM sede WHERE empresa_id = '$empresa_id'";
    $sede = $conn->query($query_sede);
    $resultado_sede = $sede->fetch_all();
   ...
   <body>
                        ...
                        <div class="modal-body">
                           ...
                           <div class="row">
                            ...
                            <div class="col">
                                ...
                                <label for="aggrol">Rol:</label>
                                <select class="browser-default custom-select" name="aggrol" id="aggrol">
                                <?php foreach($resultado_roles as $rol){ ?>
                                    <option value="<?php echo $rol[0]; ?>"><?php echo $rol[1]; ?></option>
                                <?php } ?>
                                </select>
                                ...
                                <label for="aggsede">Sede:</label>
                                <select class="browser-default custom-select" name="aggsede" id="aggsede">
                                <?php foreach($resultado_sede as $sede){ ?>
                                    <option value="<?php echo $sede[0]; ?>"><?php echo $sede[1]; ?></option>
                                <?php } ?>
                                </select>
                                ...
                                <label for="aggdpto">Departamento:</label>
                                <select class="browser-default custom-select" name="aggdpto" id="aggdpto">
                                <?php foreach($resultado_dpto as $dpto){ ?>
                                    <option value="<?php echo $dpto[0]; ?>"><?php echo $dpto[1]; ?></option>
                                <?php } ?>
                                </select>
                                ...
                                <label for="aggarea">Area:</label>
                                <select class="browser-default custom-select" name="aggarea" id="aggarea"></select>
       ...
       <?php foreach($rows as $row) { ?>
            <script type="text/javascript">
                ...
                var id_dpto = $('#dpto<?php echo $row[0]; ?>').val();
                $.ajax({
                    type: "POST",
                ...
                $('#editarbtn<?php echo $row[0]; ?>').click(function(){
                    ...
                    var name = $('#name<?php echo $row[0]; ?>').val();
                    var lastname = $('#lastname<?php echo $row[0]; ?>').val();
                    var rol = $('#rol<?php echo $row[0]; ?>').val();
       ...
       <script type="text/javascript">
            $(function(){
                ...
                $('#agregarboton').click(function(){
                    ...
                    var rol = $('#aggrol').val();
                    var dpto = $('#aggdpto').val();
                    var area = $('#aggarea').val();
                    var sede = $('#aggsede').val();

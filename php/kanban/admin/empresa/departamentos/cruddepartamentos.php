<?php
    ...
    $query = "SELECT * FROM departamento WHERE empresa_id = '$empresa_id'";
   ...
   <body>
       ...
       <div style="height: 100vh">
        ...
        <div class="container mt-1">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#modal_agregarSede">Agergar Departamento</button>

<?php
    ...
    $query = "SELECT * FROM tipo_tarea WHERE empresa_id = '$empresa_id'";
   ...
   <body>
       ...
       <div style="height: 100vh">
        ...
        <div class="container mt-1">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#modal_agregarSede">Agergar Tipo de Tarea</button>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Editar Tipo de Tarea</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="md-form">
                               <input type="text" id="dptoname<?php echo $row[0]; ?>" class="form-control" value="<?php echo $row[1]; ?>" required>
                               <label for="rolname">Tipo de Tarea</label>
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="md-form">
                               <input type="text" id="dptonameagregar" class="form-control" required>
                               <label for="rolname">Nombre del Departamentos</label>
                            </div>
       ...
       <?php foreach($rows as $row) { ?>
            <script type="text/javascript">
                $('#editarbtn<?php echo $row[0]; ?>').click(function(){
                    ...
                    var name = $('#dptoname<?php echo $row[0]; ?>').val();
